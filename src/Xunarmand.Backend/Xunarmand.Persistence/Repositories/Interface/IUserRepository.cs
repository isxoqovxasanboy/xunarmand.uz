...
public interface IUserRepository
{
    ...
    ValueTask<User?> GetByIdAsync(Guid clientId,QueryOptions queryOptions = default, CancellationToken cancellationToken = default);
    ...
    ValueTask<User> CreateAsync(User client, CommandOptions commandOptions = default, CancellationToken cancellationToken = default);
    ...
    ValueTask<User> UpdateAsync(User client, CommandOptions commandOptions = default, CancellationToken cancellationToken = default);
    ...
    ValueTask<User?> DeleteByIdAsync(Guid clientId, CommandOptions commandOptions, CancellationToken cancellationToken = default);
